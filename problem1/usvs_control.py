...
for epoch in range(epochs):
    ...
    for i in range(NumberofHunters):
        ...
        omaga_c_1 = -model_c_1.forward(allhunters[i].z_1)[1] * [allhunters[i].a * zeta_1 * allhunters[i].z_1 + 1 / 2 * allhunters[i].a * out_put_a_1 + allhunters[i].lambda_2]
        # critic 网络更新
        ...
        omaga_c_2 = -model_c_2.forward(allhunters[i].z_2)[1] * [allhunters[i].f_v - zeta_2 * allhunters[i].z_2 - 1 / 2 * out_put_a_2 - a_hat_dot]
        # critic 网络更新
